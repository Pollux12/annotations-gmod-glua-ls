...
---@param color? Color Color to draw the text in. Uses Color.
...
---@param color Color The color to fill the rectangle with. Uses the Color.
...
---@param textdata TextData The text properties. See the Structures/TextData
...
---@param textdata TextData The text properties. See Structures/TextData.
...
---@param texturedata TextureData The texture properties. See Structures/TextureData.
...
---@param boxcolor Color The box color. Uses Color.
---@param textcolor Color The text color. Uses Color.
---@param xalign? number The alignment of the X coordinate using Enums/TEXT_ALIGN.
---@param yalign? number The alignment of the Y coordinate using Enums/TEXT_ALIGN.
