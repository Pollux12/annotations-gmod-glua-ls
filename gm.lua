...
---@param view CamData The view data containing players FOV, view position and angles, see Structures/CamData
...
---@param data EmitSoundInfo Information about the played sound. Changes done to this table can be applied by returning `true` from this hook.
---
...
---@param undo Undo The undo table. See Structures/Undo struct.
