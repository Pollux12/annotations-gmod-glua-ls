...
---@param captureData RenderCaptureData Parameters of the capture. See Structures/RenderCaptureData.
...
---@param view? ViewData The view data to be used in the rendering. See Structures/ViewData. Any missing value is assumed to be that of the current view. Similarly, you can make a normal render by simply not passing this table at all.
