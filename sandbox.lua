...
---@param swep SWEP Information about the weapon the player is trying to spawn, see Structures/SWEP
...
---@param table VehicleTable Table of that vehicle, containing info about it See Structures/VehicleTable.
...
---@param tool TOOL The TOOL table to be registered. See Structures/TOOL.
